  ...
  return (
    <div className="admin">
      ...
      <div className='admin__news'>
                <div className="admin__headers">
                    <p className="admin__info admin__info-id">id</p>
                    <p className="admin__info">Автор</p>
                    <p className="admin__info">Заголовок</p>
                    <p className="admin__info">Дата публикации</p>
                    <p className="admin__action">Действия</p>
                </div>
                {
                    allNews.map((el) => (
                        <div className='admin__oneNews'
                        key={el.news_id}>
                            < p className='admin__info admin__info-id'>
                                {el.news_id}
                            </p>
                            ...
                            <div className='admin__action' onClick={() => handleDelete(el.news_id)}><DeleteIcon /></div>
                        </div>
                    ))
                }
            </div>
