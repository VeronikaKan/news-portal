  ...
  return (
    ...
    <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
        <div className='home__img'>
            <img className="rounded-t-lg " src ="https://data.kaktus.media/image/big/2023-11-01_12-37-54_989840.jpg"  alt="product"/>
        </div>
        <div className="p-5">
            <a href="#">
                <h5 className="text-gray-900 font-bold text-2xl tracking-tight mb-2 dark:text-white " >title</h5>
            </a>
            <p className= "font-normal text-gray-700 mb-3 dark:text-gray-400 home__desc"  >desc</p>
